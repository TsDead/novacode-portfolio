...
(() => {
  ...
  const PROJECTS = [
    ...
    { id: 'jobhunter', link: 'https://github.com/TsDead/job-hunter', tags: ['Python', 'LLM · Groq', 'REST API', 'SQLite', 'Telegram'],
    ...
    { id: 'coverletter', link: 'https://tsdead.github.io/ai-coverletter/', tags: ['Python', 'FastAPI', 'LLM · Groq', 'REST API'],
